...
sudo apt-get install pdfid  > /dev/null 2>&1
...
sudo apt install pdf-parser  > /dev/null 2>&1
...
sudo apt install qpdf  > /dev/null 2>&1
...
echo -e ${YELLOW} "[ ! ] Installing pdf-parser "
sudo apt install pdfcrack  > /dev/null 2>&1
